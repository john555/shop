...
export class ProductResolver {
  ...
  async product(@Args() args: GetProductArgs): Promise<Product | null> {
    return this.productService.findByIdOrSlug(args.idOrSlug);
  }
  ...
  async products(
    ...
    return this.productService.findByStoreIdOrSlug(args.storeIdOrSlug, pagination, filters);
  }
