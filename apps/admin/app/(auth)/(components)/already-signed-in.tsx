...
export function AlreadySignedIn({
  dashboardPath = DASHBOARD_PAGE_LINK,
    ...
    <div className="flex items-center justify-center min-h-screen bg-background p-4">
      <Card className="w-full max-w-lg overflow-hidden">
        ...
        <CardContent className="pt-8 pb-6">
          ...
          >
            You&apos;re already signed in. Access your dashboard to manage your
            store, view analytics, and grow your business.
          </motion.p>
        </CardContent>
        <CardFooter className="flex flex-col gap-4">
          ...
          >
            <Button
              variant="link"
              asChild
              className="text-primary hover:text-primary/80 transition-colors duration-300 cursor-pointer"
              onClick={signOut}
            >
